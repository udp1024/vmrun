...
declare -a arr=(\
	...
	"/Volumes/Crucial X8/VMs/K8 Cluster 1/k8w1/k8-w1.vmwarevm/k8-w1.vmx"\
...
declare -a arr=(\
        ...
        "/Volumes/Crucial X8/VMs/K8 Cluster 1/k8w1/k8-w1.vmwarevm/k8-w1.vmx"\
        "/Volumes/Crucial X8/VMs/K8 Cluster 1/k8w2/k8-w2.vmwarevm/k8-w2.vmx"\
	"/Volumes/Crucial X8/VMs/K8 Cluster 1/k8w3/k8-w3.vmwarevm/k8-w3.vmx"\
)

SNAPNAME=20231125151300
